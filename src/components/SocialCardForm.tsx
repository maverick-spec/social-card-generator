...
import { Upload, Linkedin, Globe } from "lucide-react";
...
const formSchema = z.object({
  ...
  about: z.string().min(10, "About should be at least 10 characters").optional(),
  interests: z.string().min(10, "Interests should be at least 10 characters").optional(),
...
export function SocialCardForm({ onUpdate, initialData = {} }: SocialCardFormProps) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      publishedWorks: initialData.publishedWorks || "",
      latestWorkLinks: initialData.latestWorkLinks || "",
      gradient: initialData.gradient || "blue",
    },
  });
